...
<main id="swup" class="transition-fade" page-ref="colleges">
    ...
    $college        = $collegeManager->fetchEdit($collegeId);
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $datas = compact('collegeId', 'title', 'about', 'youtubeLink', 'facility', 'courses', 'isDirectCollege', 'isFeatured', 'location', 'collegeImages', 'logo', 'under', 'approved');
                ...
                <form action="" method="POST" enctype="multipart/form-data" id="add-college">
                    <div class="flex form-group">
                        ...
                        <div class="input-holder split-4">
                            ...
                            <input id="approved-by" value="<?php echo $college['approved'] ?>" required name="approved-by"/>
                        </div>
                        ...
                        <div class="input-holder split-4">
                            ...
                            <select name="under" id="under" required>
                                ...
                                <option <?php echo $college['under'] === 'pvt' ? 'selected' : '' ?> value="pvt">Privet</option>
                                <option <?php echo $college['under'] === 'gov' ? 'selected' : '' ?> value="gov">Government</option>
                            </select>
                        </div>
