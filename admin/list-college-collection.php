...
<head>
    ...
    <title>All College Collection</title>
    <!-- main style -->
...
<body data-barba="wrapper">
    <main id="swup" class="transition-fade" page-ref="college-collection">
        ...
        <div class="table-options">
            <div class="option">
                <a href="add-college-collection.php"><button class="assign_button">Add College Collection<ion-icon name="add-outline">
                        </ion-icon></button></a>
            </div>
            <!-- <div class="option">
        ...
        <div class="content">
            <div class="table-container">
                <table id="list-college-collection">
                    <thead>
                        <tr>
                            <th scope="col">No</th>
